                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body px-5">
                            ...
                            <div class="form-group mb-4 d-flex">
                                ...
                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="viewUsers" type="checkbox" {!! in_array('viewUsers',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[viewUsers]" value="1" >
                                    <label for="viewUsers" class="custom-control-label">View Users</label>
                                </div>
                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="addUsers" type="checkbox" {!! in_array('addUsers',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[addUsers]" value="1" >
                                    <label for="addUsers" class="custom-control-label">Add Users</label>
                                </div>

                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="updateUsers" type="checkbox" {!! in_array('updateUsers',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[updateUsers]" value="1" >
                                    <label for="updateUsers" class="custom-control-label">Update Users</label>
                                </div>

                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="deleteUsers" type="checkbox" {!! in_array('deleteUsers',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[deleteUsers]" value="1" >
                            ...
                            <div class="form-group mb-4 d-flex">
                                ...
                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="viewRoles" type="checkbox" {!! in_array('viewRoles',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[viewRoles]" value="1" >
                                    <label for="viewRoles" class="custom-control-label">View Roles</label>
                                </div>
                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="addRoles" type="checkbox" {!! in_array('addRoles',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[addRoles]" value="1" >
                                    <label for="addRoles" class="custom-control-label">Add Roles</label>
                                </div>

                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="updateRoles" type="checkbox" {!! in_array('updateRoles',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[updateRoles]" value="1" >
                                    <label for="updateRoles" class="custom-control-label">Update Roles</label>
                                </div>

                                <div class="custom-control custom-checkbox mr-3 small">
                                    <input id="deleteRoles" type="checkbox" {!! in_array('deleteRoles',$abilitiesarray) == true ?"checked":"" !!} class=" custom-control-input " name="permission[deleteRoles]" value="1" >
